...
<html>
	...
	<body>
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类名称" value="{{$oldData['title']}}" name="title">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">作者</label>
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类名称" value="{{$oldData['author']}}" name="author">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div id="img_box">
				...
				<img src="{{$oldData['thumb']}}" style="width:250px;height:auto;" alt="" id="img">
