...
<html>
	    ...
	    <!--载入百度编辑器所需js文件-->
    		...
    		$(function(){
    			$('#close_img').click(function() {
    				// 显示上传表单*********
    				$('#img_box').html('<input id="exampleInputEmail1" type="file" name="thumb">');
    			});
    		})
    		</script>
	</head>
	<body>
		...
		<div class="alert alert-success">修改文章</div>
		<div class="form-group">
			<label for="exampleInputEmail1">文章标题</label>
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类名称" value="<?php echo $oldData['title']?>" name="title">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">作者</label>
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类名称" value="<?php echo $oldData['author']?>" name="author">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div id="img_box">
				...
				<img src="<?php echo $oldData['thumb']?>" style="width:250px;height:auto;" alt="" id="img">
