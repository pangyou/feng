	...
	<div id="search">
		...
		<div class="center">
			<div class="search">
				...
				<form action="{{U('GoodsList/index')}}" method="post">
	...
	<div id="list">
		...
		<div class="right">
			<ul>
				...
				<li><a href="{{U('GoodsList/index',array('cid'=>$v['cid']))}}">{{$v['cname']}}{{if value="$k eq 4"}} <i></i>{{endif}} </a></li>
				{{endforeach}}
			</ul>
		</div>
	</div>