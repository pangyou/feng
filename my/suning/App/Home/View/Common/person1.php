...
<div class="state">
	<div class="tab">
		<ul class="l">
			<li class="now"><a href="{{U('Person/orders')}}">全部订单</a></li>
			<li>
				<a href="{{U('Person/nopay')}}">待付款</a><em>{{$str}}</em>	
			</li>
			<li>
				<a href="{{U('Person/nore')}}">待收货</a><em>{{$str1}}</em>	
			</li>
			<li>
				<a href="{{U('Person/nocom')}}">待评价</a><em>{{$str2}}</em>	
			</li>
		</ul>
		<p class="r">
			<a href="{{U('recycleShow')}}">
				<i></i>
				订单回收站
			</a>
		</p>
