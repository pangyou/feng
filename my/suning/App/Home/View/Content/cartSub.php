...
<body>
	<form action="{{U('Orders/add')}}" method="post">
	<div id="head">
		<div class="logo">
	...
	<div id="nav">
		...
		<div class="st step3">
			<div class="title">商品服务信息<a href="{{U('cartshow')}}">返回我的购物车修改</a></div>
			<div class="son">
				<ul class="ul">
					<li class="li1">
				...
				<!-- sid隐藏域 -->
				<input type="hidden" name="sid[]" value="{{$k}}">
				<ul class="ul ul1">
					<li class="li1">
						<a class="a1" href=""><img src="{{$v['pic']}}"/></a>
						<p class="pname">
							<a href="">{{$v['name']}}</a>
						</p>
						<p class="return">
					...
					<li class="li4">{{$v['num']}}</li>
					<li class="li5">¥ {{$v['total']}}</li>
				</ul>
				{{endforeach}}
				<ul class="ul ul2">
					<li class="li1">
		...
		<div class="st step5">
			...
			<div class="son">
				...
				<div class="item3">
				{{if value="$_SESSION"}}
					<em class="now">{{$num}}</em>件商品总计：<b>¥{{$price}}</b>
				{{endif}}
				</div>
				<div class="item3">
					运费：<b>¥0.00</b>
