							...
							<tbody>
								<tr class="tr">
									<td class="td">
										...
										<a class="huishou" href="javascript:if(confirm('确定删除吗?'))location.href='{{U('del',array('olid'=>$v['olid']))}}'"></a>
									</td>
								</tr>
								<tr class="infotwo">
									<td class="td2">
									...
									<td class="price td3">
										<p class="p1"><i>¥</i><em>{{$v['subtotal']}}</em></p>
										<p class="p2">在线支付</p>
									</td>
									<td class="actuality td3">
										<p class="p1">{{$v['nstate']}}</p>
										{{if value="$v['nstate']=='未付款'"}}
										<p class="p2">
											<a href="{{U('payMoney',array('olid'=>$v['olid']))}}">付款</a>
										</p>
										<p class="p2"><a href="">查看详情</a></p>
										{{elseif value="$v['nstate']=='已付款'"}}
										<p class="p2">待发货</p>
										<p class="p2"><a href="">查看详情</a></p>
										{{elseif value="$v['nstate']=='已发货'"}}
										<p class="p2"><a href="javascript:if(confirm('确认收货吗?'))location.href='{{U('confirm',array('olid'=>$v['olid']))}}'">确认收货</a></p>
										<p class="p2"><a href="">查看详情</a></p>
										{{elseif value="$v['nstate']=='已完成'"}}
										<p class="p2"><a href="javascript:;">评价</a></p>
										<p class="p2"><a href="">查看详情</a></p>
										{{endif}}
									</td>
									<td class="touch td3">
										{{if value="$v['nstate']=='已完成'"}}
										<a class="again" href="">再次购买</a>
										{{endif}}
										<a class="again"  href="{{U('rest',array('olid'=>$v['olid']))}}">还原</a>
									</td>
								</tr>
							</tbody>
						</table>
