...
<body>	
		...
		<div class="top">
			...
			<div class="top_right">
				<ul>
					...
					<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=index">admin...</a>
	...
	<div id="my">
		<div class="my">
			<div class="left">
				<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=index"></a>
			</div>
			<div class="right">
				<ul>
					<li><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=index">首页</a></li>
					<li><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=adress">账户管理</a><i></i></li>
					<li><a href="">消息</a></li>
				</ul>
	...
	<div id="nav">
		<div class="left">
			<div class="dt">
				<i></i>
				<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=cartshow">我的购物车</a>
			</div>
			<div class="dt">
				<i class="i2"></i>
				<span>订单中心</span>
			...
			<div class="dd">
				<ul>
					<li class="now"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=orders">我的订单</a></li>
					<li><a href="">我的秒杀</a></li>
	...
	<div class="tab">
		<ul class="l">
			<li class="now"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=orders">全部订单</a></li>
			<li>
				<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=nopay">待付款</a><em>3</em>	
			</li>
			<li>
				<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=nore">待收货</a><em>4</em>	
			</li>
			<li>
				<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=nocom">待评价</a><em>5</em>	
			</li>
		</ul>
		<p class="r">
			<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Person&a=recycleShow">
				<i></i>
				订单回收站
			</a>
		</p>
							...
							<tbody>
								<tr class="tr">
									<td class="td">
										<div>
											<em>下单时间：</em>
											<span><?php echo date('Y-m-d',$vv['otime'])?></span>
										</div>
										<div>
											<em>订单编号：</em>
										...
										<a class="huishou" href="javascript:if(confirm('确定删除吗?'))location.href='<?php echo U('recycle',array('olid'=>$vv['olid']))?>'"></a>
									</td>
								</tr>
								<tr class="infotwo">
									<td class="td2">
										<a class="a1" href="">
											<img src="<?php echo $vv['oimg']?>" alt="">
										</a>
										<p>
											<a class="a2" href=""></a>
										</p>
									...
									<td class="price td3">
										<p class="p1"><i>¥</i><em><?php echo $vv['subtotal']?></em></p>
										<p class="p2">在线支付</p>
									</td>
									<td class="actuality td3">
										<p class="p1"><?php echo $vv['nstate']?></p>
										<?php if($vv['nstate']=='未付款'){?>
                
										<p class="p2">
											<a href="<?php echo U('payMoney',array('olid'=>$vv['olid']))?>">付款</a>
										</p>
										<p class="p2"><a href="">查看详情</a></p>
										<?php }else if($vv['nstate']=='已付款'){?>
										<p class="p2">待发货</p>
										<p class="p2"><a href="">查看详情</a></p>
										<?php }else if($vv['nstate']=='已发货'){?>
										<p class="p2"><a href="javascript:if(confirm('确认收货吗?'))location.href='<?php echo U('confirm',array('olid'=>$vv['olid']))?>'">确认收货</a></p>
										<p class="p2"><a href="">查看详情</a></p>
										<?php }else if($vv['nstate']=='已完成'){?>
		...
		<div class="foryou">
			...
			<div class="imgscroll">
				<div class="all">
					<ul>
																	<li>
							<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=60">
							<img src="Upload/Content/16/06/23941465807785.jpg" alt="" />
							</a>
							<p class="text"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=60">华为Mate S（CRR-UL00）双4G臻享32G版（极昼金）</a></p>
							<span>
								<i>¥</i>
								<em>2399.00</em>
							</span>
												...
												<li>
							<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=61">
							<img src="Upload/Content/16/06/26051465807926.jpg" alt="" />
							</a>
							<p class="text"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=61">华为麦芒4 RIO-AL00 全网通4G手机 晨曦金</a></p>
							<span>
								<i>¥</i>
								<em>2299.00</em>
							</span>
												...
												<li>
							<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=62">
							<img src="Upload/Content/16/06/26011465808171.jpg" alt="" />
							</a>
							<p class="text"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=62">荣耀畅玩5X（KIW-TL00H）（2GB RAM）移动4G版（暗夜灰）</a></p>
							<span>
								<i>¥</i>
								<em>999.00</em>
							</span>
												...
												<li>
							<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=63">
							<img src="Upload/Content/16/06/59111465808330.jpg" alt="" />
							</a>
							<p class="text"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=63">华为 G7Plus  RIO-UL00双4G（香槟银）</a></p>
							<span>
								<i>¥</i>
								<em>1699.00</em>
							</span>
												...
												<li>
							<a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=64">
							<img src="Upload/Content/16/06/48571465808489.jpg" alt="" />
							</a>
							<p class="text"><a href="http://kyouyuan.club/my/suning/index.php?m=Home&c=Content&a=index&gid=64">华为 P8max 移动联通标配版双4G（银色）</a></p>
							<span>
								<i>¥</i>
								<em>1988.00</em>
							</span>
