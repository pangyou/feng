		...
		<div class="top">
			...
			<div class="top_right">
				<ul>
					...
					<a href="http://127.0.0.1/suning/index.php?m=Home&c=Person&a=index"><div style="border: 1px solid #990000;padding-left: 20px;margin: 10px;font-family: Monaco,Menlo,Consolas,monospace;">
    <h3 style="font-size: 18px;margin: 20px 0;">Undefined index: nickname</h3>
    <p style="font-size: 14px;margin: 15px 0;">
        Severity: E_NOTICE    </p>
    <p>
        File: D:\Program\www\suning\Storage\view\compile\0f6cd6d6bc9487b9f8374f88b94099c7.php    </p>
    <p>
        Line: 19    </p>
</div>...</a>
										</li>
					<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=Reg&a=index">注册</a></li>
	...
	<div id="list">
		<div class="left">
			<a href="javascript:;" class="a1">
				...
				<div class="right">
			<ul>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=75">服装城 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=76">苏宁会员 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=77">电器城 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=78">苏宁超市 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=79">红孩子母婴                 <i></i>
                </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=80">大聚惠 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=81">苏宁金融 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=82">海外购 </a></li>
								<li><a href="http://127.0.0.1/suning/index.php?m=Home&c=GoodsList&a=index&cid=83">中华特色馆 </a></li>
							</ul>
		</div>
	</div>
	<!--菜单设置结束
	...
	<div class="wrapper proinfo">
		...
		<div class="proinfo_main">
			...
			<dl class="dv dv5">
				<dt><?php echo $k?></dt>
				<dd>
					<?php foreach ($v['taname'] as $kk=>$va){?>
					<a class="adda1"  gaid="<?php echo $kk?>" href="javascript:;">
						<!-- <img src="./Public/Home/images/cona10.jpg" alt="" /> -->
						<i></i>
						<?php echo $va?>
					</a>
					<?php }?>
			...
			<dl class='dv dv11'>
				...
				<dd>
					<p id="namejson" ></p>
					<p class="goumai">
						<a class="son1" href="">立即购买</a>
						<input class="submitCart" type="submit" value="加入购物车">
						<!-- <a class="son2" href="">加入购物车</a> -->
						<a class="son3" href="">
							<i class="i1"><img src="./Public/Home/images/" alt="" /></i>
							客户端购买
							<i class="i2"></i>
						</a>
					</p>
...
4、请您收货后与快递人员一起开箱验货，确保产品完好，生产日期认可。如有问题请当场拒收。</p>
		...
		<div class="footer2">
			<div class="footer2_con">
				<div class="left">
					<dl>
						<dt>	
							<a href=""><img src="./Public/Home/images/footer2.png" alt="" /></a>
						</dt>
						<dd>
							<p class="p1"><a href="">政府采购</a></p>
							<p class="p2"><a href="">为企业用户量身定做的采购平台，优选苏宁易购全站商品，为企业采购提供专业化的一站式采购解决方案。</a></p>
						</dd>
					</dl>
					<dl>
						<dt>	
							<a href=""><img src="./Public/Home/images/f2.png" alt="" /></a>
						</dt>
						<dd>
							<p class="p1"><a href="">苏宁众包</a></p>
							<p class="p2"><a href="">以苏宁全渠道包销为主要特点，整合全社会众包资源，扶持创新企业，推广创新产品。</a></p>
						</dd>
					</dl>
				</div>
				<div class="right">
	...
	$(function(){
	    ...
	    // 未来时间
	    var future_time = new Date(2016,6,15,12,30,30);
