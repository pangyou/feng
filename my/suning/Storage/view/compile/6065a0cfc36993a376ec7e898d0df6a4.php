...
<html>
	...
	<body>
		...
		<div class="form-group dv2">
			...
			<input type="radio" class="radio" <?php if($oldData['ishot'] == '是'){?>
                checked
               <?php }?> value="是" name="ishot" id="">
			<span>是</span> 
			<input type="radio" class="radio"<?php if($oldData['ishot'] == '否'){?>
                checked
               <?php }?> value="否" name="ishot" id="">
			<span>否</span>
		</div>
		<div class="form-group">
			...
			<div id="img_box">
				...
				<img src="<?php echo $oldData['logo']?>" style="width:250px;height:auto;" alt="" id="img">
