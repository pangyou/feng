			...
			<div class="right">
						...
						<dd>
							<div class="price">
								<?php 
									...
									$temp[$k] = 0;
								 ?>
								<a <?php if($param[$k] == 0): ?>class="now"<?php endif ?> href="<?php echo U('GoodsList/index',array('cid'=>$_GET['cid'],'param'=>implode('_',$temp)))?>">不限</a>
								<?php foreach ($v['value'] as $va){?>
								<?php 
									$temp[$k] = $va['gaid'];
								 ?>
								<a <?php if($param[$k] == $va['gaid']): ?>class="now"<?php endif ?> href="<?php echo U('GoodsList/index',array('cid'=>$_GET['cid'],'param'=>implode('_',$temp)))?>"><?php echo $va['gavalue']?></a>
								<?php }?>
							</div>
						</dd>
					</dl>
				...
				<div id="content">
					...
					<!-- 调取数据库里的图片 -->
						...
						<li class="ul_li1">
							<div class="img1">
								<a href="<?php echo U('Content/index',array('gid'=>$v['gid']))?>" target="_blank" ><img src="<?php echo $v['pic_list'][0]?>" alt="" /></a>
							</div>
							<div class="img_change">
								<?php foreach ($v['pic_list'] as $vv){?>
								<a href="<?php echo U('Content/index',array('gid'=>$v['gid']))?>" target="_blank" ><img src="<?php echo $vv?>" alt="" /></a>
								<?php }?>
