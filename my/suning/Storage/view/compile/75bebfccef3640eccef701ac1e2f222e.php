...
<body>
	<!--头部设置开始-->
	<div id="top">
		<a href="<?php echo U('Index/index')?>"><img src="./Public/Home/images/logo.png" alt="" /></a>
		<a class="login-a1" href="">
			<span></span>
			我想对“登录”提意见
		</a>
	</div>
			...
			<form action='' method='post'  class='login-form'>
				<div class="right">
					...
					<div class="cont">
						...
						<div class="text-box">
							<i></i>
							<input type="text" name="nickname" placeholder="用户名/手机/邮箱/门店会员卡号" id="" />
						</div>
						<div class="text-box">
							<i class="i2"></i>
						...
						<div class="mb11">
							<a class="reg" href="<?php echo U('Reg/index')?>">免费注册></a>
							<a class="foreget" href="">忘记密码</a>
						</div>
						<div class="hezuo">
							<p class="p1">
								<span>用合作网站帐号登录</span>
