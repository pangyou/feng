	...
	<body>
		...
		<div class="form-group">
			...
			<select name="category_cid" id="cate" class="form-control">
				...
				<option value="<?php echo $v['cid']?>" tid='<?php echo $v['type_tid']?>'  <?php if($oldData['category_cid']==$v['cid']){?>
                selected
		...
		<div class="form-group">
			...
			<select name="brand_bid" class="form-control">
				...
				<option value="<?php echo $v['bid']?>" <?php if($oldData['brand_bid']==$v['bid']){?>
                selected
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入商品库存"  name="inventory" value="<?php echo $oldData['total']?>">
		</div>
		<div class="form-group">
						...
						<tr>
							...
							<td>
								<select name="attr[<?php echo $v['taid']?>]" id="">
									<option value="0">--请选择--</option>
									<?php foreach ($v['tavalue'] as $va){?>
									<option value="<?php echo $va?>" <?php if($v['gavalue']==$va){?>
                selected
               <?php }?> ><?php echo $va?></option>
									<?php }?>
								</select>
							</td>
						</tr>
		...
		<div class="alert alert-success dv">
			...
			<div id="a3son">
				<!--调用百度编辑器-->
				<script id="editor" type="text/plain" style="width:100%;height:500px;" name="detail"><?php echo $oldGoodsDetail['detail']?></script>
				<script>
		...
		<div class="alert alert-success dv">
			...
			<div id="a6son">
				<!--调用百度编辑器-->
				<script id="editor2" type="text/plain" style="width:100%;height:500px;" name="service"><?php echo $oldGoodsDetail['service']?></script>
				<script>
