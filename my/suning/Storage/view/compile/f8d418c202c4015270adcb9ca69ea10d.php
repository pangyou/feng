...
<body>
	<!--头部设置开始-->
	<div id="top">
		<a class="a1" href="<?php echo U('Index/index')?>"><img src="./Public/Home/images/logo.png" alt="" /></a>
		<span class="sp1"></span>
		<p>
			我已经注册,马上<a href="<?php echo U('Login/index')?>">登录></a>
		</p>
	</div>
	<!--头部设置结束-->	
	<!--内容部分设置开始-->	
		...
		<div id="main">
			<div class="son">
				...
				<div class="son2">
					...
					<img src="<?php echo U('code')?>" class="img" onclick="this.src = this.src + '&mt=' + Math.random()" title="看不清?点我换一张">
				</div>
				<div class="auto">
