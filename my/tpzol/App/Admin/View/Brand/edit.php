...
<html>
	...
	<body>
		...
		<div class="form-group dv2">
			...
			<input type="radio" class="radio" <if condition="$oldData['hot'] == '是'" >checked</if> value="是" name="hot" id="">
			<span>是</span> 
			<input type="radio" class="radio"<if condition="$oldData['hot'] == '否'" >checked</if> value="否" name="hot" id="">
			<span>否</span>
		</div>
		<div class="form-group">
