...
<html>
	...
	<body>
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类名称" required="" value="{{$oldData['cname']}}" name="cname">
		</div>
		<div class="form-group">
			...
			<select name="pid" class="form-control">
				...
				<option value="{{$v['cid']}}" <if condition="$oldData['pid'] eq $v['cid']" >selected</if>>{{$v['_name']}}</option>
				</foreach>
			</select>
		</div>
		<div class="form-group">
			...
			<select name="type_tid" class="form-control">
				...
				<option value="{{$v['tid']}}" <if condition="$oldData['type_tid'] eq $v['tid']">selected</if>>{{$v['tname']}}</option>
				</foreach>
			</select>
		</div>
		<div class="form-group">
		...
		<input type="hidden" name="cid" value="{{$_GET['cid']}}" id="">
		</form>
	</body>
</html>
