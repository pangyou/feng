...
<html>
			    		...
			    		success:function(phpData){
			    			...
			    			$.each(phpData,function(k,v) {
			    				...
			    				if(v.class=="属性"){
				    				...
				    				strg += '</select></td><td>附加价格</td><td><input type="text" value="0" name="spec['+v.taid+'][added][]" ></td><td><a class="btn btn-sm btn-primary addl" href="javascript:;">添加规格</a></td></tr></table></div>'; 
				    				htmlg += strg;
				    			}
	...
	<body>
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入商品市场价" name="mprice" value="0">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">商城价</label>
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入商品商城价" value="0" name="sprice">
		</div>
		<div class="form-group">
