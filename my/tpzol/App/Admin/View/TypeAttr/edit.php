...
<html>
	...
	<body>
		...
		<div class="form-group dv2">
			...
			<input type="radio" class="radio" value="属性"<if condition="$oldData['class'] eq '属性'">checked</if> name="class" id="">
			<span>属性</span> 
			<input type="radio" class="radio" value="规格" <if condition="$oldData['class'] eq '规格'">checked</if> name="class" id="">
			<span>规格</span>
		</div>
