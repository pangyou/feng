...
<html>
	...
	<body>
		...
		<div id="top">
			<div id="search">
				<!--logo开始-->
				<a href="{{:U('Index/index')}}"><img class="logo" src="__PUBLIC__/Home/images/02.png"/></a>
				<!--logo结束-->
				...
				<div class="register">
					还没有ZOL商城账号？<a href="{{:U('Login/index')}}">立即登录</a>
				</div>
			...
			<div class="r_l">
				<form action="" method="post">
					...
					<dl>
						...
						<dd><img src="{{:U('Reg/code')}}" title="看不清?点我换一张"  onclick="this.src = this.src + '?' + Math.random()"/></dd>
					</dl>
					<input class="sub" type="submit" value="注册"/>
				</form>
			</div>
			<div class="r_r">
				<img src="__PUBLIC__/Home/images/55.png"/>
			</div>
		</div>
		<!--注册结束-->
		<!--底部开始-->
