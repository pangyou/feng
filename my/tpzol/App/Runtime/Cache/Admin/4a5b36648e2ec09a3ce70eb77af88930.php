...
<html>
	<head>
	    ...
	    <![endif]-->
      <!--载入百度编辑器所需js文件-->
    	<script type="text/javascript" charset="utf-8" src="/tpzol/Public/Admin/ueditor1_4_3/ueditor.config.js"></script>
		<script type="text/javascript" charset="utf-8" src="/tpzol/Public/Admin/ueditor1_4_3/ueditor.all.min.js"> </script>
		<script type="text/javascript" charset="utf-8" src="/tpzol/Public/Admin/ueditor1_4_3/lang/zh-cn/zh-cn.js"></script>
		<!-- 上传插件需要载入的文件 -->
	    <script type="text/javascript" src="/tpzol/Public/jquery-1.8.2.min.js"></script>
	    <script type="text/javascript" src="/tpzol/Public/uploadify/jquery.uploadify.min.js"></script>
	    <link rel="stylesheet" type="text/css" href="/tpzol/Public/uploadify/uploadify.css">
	    <style type="text/css">
			.uploadify-button{
				font-size: 18px;
			}
        ...
        $(function() {
            ...
            $('#f').uploadify({
                ...
                'swf'      : "/tpzol/Public/uploadify/uploadify.swf",
	...
	<body>
		...
		<div class="form-group">
			...
			<select name="category_cid" id="cate" class="form-control">
				...
				<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v['cid']); ?>" tid='<?php echo ($v['type_tid']); ?>'><?php echo ($v['_name']); ?></option><?php endforeach; endif; ?>
			</select>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入商品库存"  name="total">
		</div>
		<div class="form-group">
