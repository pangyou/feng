	...
	<body>
		...
		<div class="form-group">
			...
			<select name="pid" class="form-control">
				...
				<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v['cid']); ?>" <?php if($oldData['pid'] == $v['cid']): ?>selected<?php endif; ?>><?php echo ($v['_name']); ?></option><?php endforeach; endif; ?>
			</select>
		</div>
		<div class="form-group">
			...
			<select name="type_tid" class="form-control">
				...
				<?php if(is_array($typeData)): foreach($typeData as $key=>$v): ?><option value="<?php echo ($v['tid']); ?>" <?php if($oldData['type_tid'] == $v['tid']): ?>selected<?php endif; ?>><?php echo ($v['tname']); ?></option><?php endforeach; endif; ?>
			</select>
		</div>
		<div class="form-group">
