...
<article>
  ...
  <div class="bloglist left">
   <!--wz-->
    <div class="wz">
    <h3>关于响应式布局</h3>
    <p class="dateview"><span>2013-11-04</span><span>作者：安然</span><span>分类：[<a href="#">web前端</a>]</span></p>
  ...
  <aside class="right"> 
    <div class="my">
     ...
     <img src="" width="200" height="200" alt="博主">
       <ul>
        <li>博主：少年</li>
        <li>职业:web前端、网站运营</li>
    ...
    <ul class="website">
      <li><a href="#">个人博客</a></li>
      <li><a href="wwww.duanliang920.com">安然博客</a></li>
    </ul> 
    </div> 
</article>
<footer>
  <p><span>Design By:<a href="www.duanliang920.com" target="_blank">安然</a></span><span>网站地图</span><span><a href="/">网站统计</a></span></p>
</footer>
